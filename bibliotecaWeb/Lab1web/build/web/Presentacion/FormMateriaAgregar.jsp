...
<html>
 ...
 <body bgcolor="white">
        <div>
            ...
            <form name="formuMateria" method="post" action="/Lab1web/MateriaControl?action=<%=Constantes.INSERTAR%>">
                <div>
                    <table border="0" align="center" width="600px">
                        ...
                        <tr>
                            <td align="left"id="edad">* Creditaje:</td>
                            <td><input size="30" type="text" name="cre" id="cre"></td>
                        </tr>
                        <tr>
