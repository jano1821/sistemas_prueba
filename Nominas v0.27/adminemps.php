...
<h2><img src="imagenes/permisosmenu.png"  alt="permisosmenu"> Administraci&oacute;n de estados de los empleados</h2>
...
echo('
<form method="post"/>
 <div id="error"> ADVERTENCIA: Una vez pulsado el bot&oacute;n Modificar, todos los empleados con el estado seleccionado, 
...
elseif (empty($nombreestado)) {
	...
	$result = mysql_query("UPDATE `t_estadosemp` SET `descestado` = '$nombreestado'  WHERE `t_estadosemp`.`idestado` = '$idestado'; ");
	if($result)
	{
...
<tr> <th colspan="4"> <b> Crear Nuevo Estado del Empleado: </b> </th> </tr>
<tr><td>&nbsp </td></tr>
<form method="post"/>

 <tr><td colspan="4"><b>Datos del Estado del Empleado: </b></td></tr>
<tr><td>&nbsp</td></tr>
 <tr> 
  		  <td> <label> Nombre del Estado del Empleado: </label></td>
 </tr>
<tr>
   	 <td colspan="4"> <textarea cols="72" rows="1" name="descestado"> </textarea></td> 
</tr>
<tr>
	<td colspan="4"> <center><INPUT type="submit" name="altaestado" value="Crear Nuevo Estado del Empleado" size="20"> </center></td>
</tr>
 </table>
 </form>
...
if (empty($descestado)) {
	...
	include("conectarbbdd.php");
	$result = mysql_query("INSERT INTO `t_estadosemp` (`idestado`, `descestado`) VALUES (NULL, '$descestado'); ");
	if($result)
	{
