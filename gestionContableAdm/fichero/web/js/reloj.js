...
//  textoFinal = (Dia+", "+DiaActual+" de "+Mes+" de "+Anio+"       [ "+horas+":"+minutos+":"+segundos+" "+cir+" ]");
  textoFinal = (Dia+", "+DiaActual+" de "+Mes+"       [ "+horas+":"+minutos+" "+cir+" ]");

  //si quieres poner algo en el titulo
  //document.title = textoFinal;

  document.getElementById('date_time').innerHTML = textoFinal;

  //repite cada 1 segundo
  setTimeout("reloj()",60000); // 1 Min
//  setTimeout("reloj()",1000); // 1 Seg
}
